package com.chenxiaofei.disruptflow.common.enums;
...
public enum RetryDisruptorTaskEnum {
    ...
    CANCEL_SHOP_INVENTORY(5,"门店库存取消","orderCancelReturnShopInventory"),
    CANCEL_WAREHOUSE_INVENTORY(6,"取消归还仓库库存","orderCancelReturnWarehouseInventory"),
